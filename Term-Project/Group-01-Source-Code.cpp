        ...
        { 
            while(true)
            {
                ...
                switch(input)
                {
                    case 1:
                    {
                        clearFileBeforWriting("/Users/saifmohammed/Desktop/Player-Database/Player-Database-CWC-2023.csv");
...
void showAllPlayerData(Player* head)
{
    ...
    while (current != NULL)
    {
        ...
        writePlayerToCSV(current, "/Users/saifmohammed/Desktop/Player-Database/Player-Database-CWC-2023.csv");
